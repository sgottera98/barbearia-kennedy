    ...
    <section className="container mx-auto px-2 xl:px-48 pb-4">
      <div className="bg-neutral-black xl:bg-neutral-black rounded-lg p-6 xl:px-16">
        ...
        <div className="flex flex-col gap-4 md:flex-row">
          <div className="bg-default h-2/4 rounded-lg" data-aos="zoom-in">
          ...
          <div className="bg-default h-2/4 rounded-lg" data-aos="zoom-in" data-aos-delay="200">
            <div className="pt-6 flex justify-center">
          ...
          <div className="bg-default h-2/4 rounded-lg" data-aos="zoom-in" data-aos-delay="400">
            <div className="pt-6 flex justify-center">
